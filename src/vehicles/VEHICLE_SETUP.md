...
| `rampSpeed` | 0.1 | 0.22 | 0.6 | Fraction of maxSpeed at which steer authority peaks. Lower = sharper low-speed steering sooner. Authority is always 0 at a dead stop (no rotation in place). |
