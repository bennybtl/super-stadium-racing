<template>
  ...
  <div class="mb-6 grid grid-cols-1 items-start gap-2">
    <div
      v-for="u in store.upgrades"
      :key="u.id"
      class="text-xs uppercase italic tracking-[0.14em] text-white flex">
      <div
          class="flex-1 text-right px-3 py-1 text-base font-bold uppercase italic tracking-[0.1em] text-white"      
        >
        {{ u.label }}
      </div>
      <div
      ...
      <div class="flex-1 text-left mx-4">
        <button
