  ...
  <div class="w-[min(90vw,480px)] mx-auto px-12 py-10 text-center">
    ...
    <div class="flex flex-col gap-7 items-stretch mb-8">
      <div class="w-full flex items-center gap-6">
        ...
        <input type="range" min="0" max="100" v-model.number="engine" class="basis-[180px] shrink-0 accent-[#ffd400] h-1 rounded bg-[#222]" />
      ...
      <div class="w-full flex items-center gap-6">
        ...
        <input type="range" min="0" max="100" v-model.number="effects" class="basis-[180px] shrink-0 accent-[#ffd400] h-1 rounded bg-[#222]" />
      ...
      <div class="w-full flex items-center gap-6">
        ...
        <input type="range" min="0" max="100" v-model.number="music" class="basis-[180px] shrink-0 accent-[#ffd400] h-1 rounded bg-[#222]" />
